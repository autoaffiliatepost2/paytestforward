            ...
            for message in reversed(messages):
                ...
                if keywords:
                    ...
                    if message.media and isinstance(message.media, MessageMediaPhoto):
                        ...
                        await self.client.send_file(destination_channel_id, input_media, caption=message.text)
...
async def main():
    ...
    if choice == "1":
        ...
        source_chat_id = -1001388213936##-1001242185176 #-1001581472837 # -1001822686940  #int(input("Enter the source chat ID: "))
        destination_channel_id = -1001822686940 #int(input("Enter the destination chat ID: "))
